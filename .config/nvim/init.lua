...
if vim.g.vscode then
    ...
    require('lazy').setup({
        ...
        "kylechui/nvim-surround", "rmagatti/auto-session",
        "editorconfig/editorconfig-vim", "mfussenegger/nvim-lint",
        "folke/trouble.nvim", "sbdchd/neoformat", "luukvbaal/stabilize.nvim",
        "RRethy/vim-illuminate", "folke/todo-comments.nvim",
        "DanilaMihailov/beacon.nvim", {
            "nvim-lualine/lualine.nvim",
            requires = {"kyazdani42/nvim-web-devicons", opt = true}
        }, "RRethy/nvim-base16", "karb94/neoscroll.nvim",
        "petertriho/nvim-scrollbar", {"j-hui/fidget.nvim", tag = "legacy"},
        "terrortylor/nvim-comment",
        "JoosepAlviste/nvim-ts-context-commentstring", "fedepujol/move.nvim",
        "sindrets/diffview.nvim", "github/copilot.vim", {
